...
static inline int do_huge_pud_anonymous_page(struct vm_fault *vmf)
{
	return VM_FAULT_FALLBACK;
}
static inline vm_fault_t do_huge_pud_wp_page(struct vm_fault *vmf, pud_t orig_pud)
{
	return VM_FAULT_FALLBACK;
}
static inline struct page *follow_trans_huge_pud(struct vm_area_struct *vma,
					  unsigned long addr,
					  pud_t *pud,
					  unsigned int flags)
{
...
#else
#define transparent_pud_hugepage_enabled __transparent_hugepage_enabled
#endif
