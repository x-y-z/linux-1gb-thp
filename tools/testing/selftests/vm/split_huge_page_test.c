...
void punch_holes_in_pagecache_thp(size_t fd_size, off_t offset[], off_t len[], int n)
{
	int fd, j;
	char *addr;
	size_t i;
...
int main(int argc, char **argv)
{
	...
	offset[0] = 120 * pagesize;
	offset[1] = 4 * pagesize;
	len[0] = 200 * pagesize;
	len[1] = 16 * pagesize;
	punch_holes_in_pagecache_thp(fd_size, offset, len, 2);

	offset[0] = 258 * pagesize + pagesize / 2;
	offset[1] = 32 * pagesize;
	len[0] = 127 * pagesize;
	len[1] = 16 * pagesize;
	punch_holes_in_pagecache_thp(fd_size, offset, len, 2);
